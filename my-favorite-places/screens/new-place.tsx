...
const NewPlaceScreen = () => {
  ...
  const savePlace = useCallback(async () => {
    ...
    try {
      ...
      const token =
        "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzUxMiJ9.eyJpc3MiOiJtYXBzYXBpIiwidGlkIjoiNlc4QjZHOUtZRCIsImFwcGlkIjoiNlc4QjZHOUtZRC5tYXBzLmNvbS5raW4iLCJpdGkiOmZhbHNlLCJpcnQiOmZhbHNlLCJpYXQiOjE3NTExNzk1NDAsImV4cCI6MTc1MTE4MTM0MH0.EF5549YsQFojFBntpJxyHXYlFMe25rtNxWbLPjcPyjjCDKRv6k-4IdFVnZI0SFyaYRBdtSe4LhVzKt0vTPhbpg";
